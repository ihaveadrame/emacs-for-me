...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slime" '("symbol-at-point." "sexp-at-point.1" "disconnect-" "inferior-lisp-program" "in-sldb-face" "inspector" "indentation" "inter" "loop-interrupt-" "locally-bound-debugger-hook" "break" "make-slime-" "macroexpand" "unwind-to-previous-sldb-level" "arglist" "async-eval-debugging" "comp" "find-definition" "narrowing" "??" "?q" "?i" "?v" "?l" "?d" "?e" "?c" "?n" "?t" "*slime-threads-table-properties*" "when-let" "with-struct")))
